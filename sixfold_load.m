...
load('50_comb_6_loads')
loads_combination = y;


load('10_comb_trig_6_loads')
trig = y;
...
for i=1:length(loads_combination)
    ...
    for j=1:length(trig)
        ...
        c6 = trigger_label(c6);
                ...
                off_1 = on_1 + (cycle*600);
                off_2 = on_2 + (cycle*600);
                off_3 = on_3 + (cycle*600);
                off_4 = on_4 + (cycle*600);
                off_5 = on_5 + (cycle*600);
                off_6 = on_6 + (cycle*600);
                ...
                label = string(simu_blocks(sim1) + '+' + simu_blocks(sim2) + '+' + simu_blocks(sim3)+ '+' + simu_blocks(sim4)+ '+' + simu_blocks(sim5)+ '+' + simu_blocks(sim6));
                trigger_angle = [(c1*60*180);(c2*60*180); (c3*60*180); (c4*60*180); (c5*60*180); (c6*60*180)] ;
