...
for i=1:length(cargas)
    ...
    for j=1:length(disp)
        ...
        c4 = label_disp(c4);
                ...
                off_1 = on_1 + (ciclo*400);
                off_2 = on_2 + (ciclo*400);
                off_3 = on_3 + (ciclo*400);
                off_4 = on_4 + (ciclo*400);
                ...
                label = string(simu_1(sim1) + '+' + simu_1(sim2) + '+' + simu_1(sim3)+ '+' + simu_1(sim4));
                angulo_disparo = [(c1*60*180);(c2*60*180); (c3*60*180); (c4*60*180)] ;
